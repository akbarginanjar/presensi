...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Keterangan</h4>
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="/admin/pengguna">keterangan</a>
                </li>
                <li class="separator">
                    <i class="fa-solid fa-chevron-right"></i>
                </li>
                <li class="nav-item">
                    <a href="">Data Keterangan</a>
                </li>
            </ul>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card-title"> Data Keterangan</div>
                    </div>
                    <div class="col">
                        ...
                        <tbody>
                           ...
                           @foreach ($keterangan as $item)
                               <tr>
                                ...
                                <td>
                                    <form action="{{route('keterangan.destroy', $item->id)}}" method="post">
                                ...
                                <div class="modal-dialog modal-lg border-0" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('keterangan.update', $item->id) }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" value="{{ $item->keterangan }}"
                                                            placeholder="Masukkan Jadwal" name="keterangan"
                                                            autocomplete='off'
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
        ...
        <div class="modal-dialog modal-lg border-0" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title" id="modalSayaLabel">Tambah Data Keterangan</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('keterangan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="" class="mb-2">Masukan Keterangan</label>
