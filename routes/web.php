...
use App\Http\Controllers\TbJadwalController;
use App\Http\Controllers\TbPegawaiController;
use App\Http\Controllers\UserController;
use App\Http\Controllers\TbKeteranganController;
use App\Http\Controllers\TbKerjaController;
use App\Http\Controllers\TbRiwayatController;
...
Route::group(
    ...
    function () {
        ...
        Route::resource('pegawai', TbPegawaiController::class);
        Route::resource('jadwal', TbKerjaController::class);
        Route::resource('keterangan', TbKeteranganController::class);
        Route::resource('riwayat', TbRiwayatController::class);
