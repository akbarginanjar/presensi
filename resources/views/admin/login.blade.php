...
<body><br><br><br>
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-6"><br><br>
               ...
               <hr>
              <center>
                <h5>Silahkan Login Demi Keamanan Bersama</h5>
                <br>
                 <form class="" action="/admin/login/proses" method="POST">
                     @csrf
 ...
 <br>
            ...
            <div class="col">
                <div class="card">
                    <img src="{{asset('images/ikon/logins.png')}}" width="90%">
                   </div>
            </div>
        </div>
      </div>
