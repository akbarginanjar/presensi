<div class="main-header">
    <!-- Logo Header -->
    <div class="logo-header" style="background: rgb(255, 132, 0)">
        ...
        <a href="/admin/dashboard" class="logo" style="margin-bottom: 12px; margin-left: 15px;">
            ...
            <img src="{{ asset('images/ikon/logo.png') }}" width="50px" alt="">
            <h1 class="navbar-brand text-white mt-2">BPBD </h2>
        </a>
    ...
    <!-- Navbar Header -->
    <nav class="navbar navbar-header navbar-expand-lg" style="background: rgb(255, 132, 0)">
