...
<head>
    ...
    <title>Icommits</title>
    <meta content="" name="description">

    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('assets/frontend/assets/img/logo-icommits.png') }}" rel="icon">
    <link href="{{ asset('assets/frontend/assets/img/logo-icommits.png') }}" rel="apple-touch-icon">
