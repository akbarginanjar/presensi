...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Jadwal Kerja</h4>
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="/admin/pengguna">Jadwal</a>
                </li>
                <li class="separator">
                    <i class="fa-solid fa-chevron-right"></i>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a class="btn btn-primary text-white float-right" data-toggle="modal" data-target="#tambah"
                            href="{{route('jadwal.create')}}">Tambah
                         Jadwal Kerja</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($jadwal as $item)
                                <tr>
                                    <td> {{ $no++ }} </td>
                                    <td> {{$item->jadwal}} </td>
                                    <td> Pukul ( {{$item->jam_masuk}} ) </td>
                                    <td> pukul ( {{$item->jam_pulang}} )</td>
                                    <td> 
                                                ...
                                                <form action="{{ route('jadwal.update', $item->id) }}" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group ">
                                                            <input type="text" value="{{ $item->jadwal }}"
                                                                placeholder="Masukkan Jadwal" name="jadwal"
                                                                autocomplete='off'
                                                        ...
                                                        <input type="time" name="jam_masuk" class="form-control" value="{{$item->jam_masuk}}">
                                                        <br>
                                                        <label for="">Jam pulang</label>
                                                        <input type="time" name="jam_pulang" class="form-control" value="{{$item->jam_pulang}}">
                                                    </div>
                                            </div>
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
        ...
        <div class="modal-dialog modal-lg border-0" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title" id="modalSayaLabel">Tambah Data Jadwal</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('jadwal.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name" class="label">Jadwal</label>
                            <input id="" type="text" class="form-control"
                                name="jadwal" required placeholder="Masukan Jadwal Baru"
